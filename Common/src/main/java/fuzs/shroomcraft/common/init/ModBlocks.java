...
import fuzs.shroomcraft.common.world.level.block.SproutsBlock;
import fuzs.shroomcraft.common.world.level.block.TinyMushroomCropBlock;
...
public class ModBlocks {
    ...
    public static final Holder.Reference<Block> TINY_BROWN_MUSHROOM = ModRegistry.REGISTRIES.registerBlock(
            ...
            (BlockBehaviour.Properties properties) -> new TinyMushroomCropBlock(properties,
                    Blocks.BROWN_MUSHROOM.builtInRegistryHolder()),
    ...
    public static final Holder.Reference<Block> TINY_RED_MUSHROOM = ModRegistry.REGISTRIES.registerBlock(
            "tiny_red_mushroom",
            (BlockBehaviour.Properties properties) -> new TinyMushroomCropBlock(properties,
                    Blocks.RED_MUSHROOM.builtInRegistryHolder()),
    ...
    public static final Holder.Reference<Block> TINY_BLUE_MUSHROOM = ModRegistry.REGISTRIES.registerBlock(
            "tiny_blue_mushroom",
            (BlockBehaviour.Properties properties) -> new TinyMushroomCropBlock(properties, BLUE_MUSHROOM),
    ...
    public static final Holder.Reference<Block> TINY_ORANGE_MUSHROOM = ModRegistry.REGISTRIES.registerBlock(
            ...
            (BlockBehaviour.Properties properties) -> new TinyMushroomCropBlock(properties, ORANGE_MUSHROOM),
    ...
    public static final Holder.Reference<Block> TINY_PURPLE_MUSHROOM = ModRegistry.REGISTRIES.registerBlock(
            ...
            (BlockBehaviour.Properties properties) -> new TinyMushroomCropBlock(properties, PURPLE_MUSHROOM),
